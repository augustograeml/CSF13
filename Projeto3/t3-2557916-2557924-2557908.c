...
Imagem1C** alocaMatriz (Imagem1C *controle);
void destroiMatriz (Imagem1C* meDestrua);
...
{
    int i;
    for(i = 0; i < meDestrua->largura; i++)
        free(meDestrua->dados[i]);

    free (meDestrua->dados);
}
