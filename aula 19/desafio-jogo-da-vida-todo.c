...
int main()
{
    ...
    /* TODO: comente adequadamente explicando essa chamada de funcao
       é necessário chamar essa função uma vez que podemos usar diferentes arquivos
       a função jogo é chamada para que o jogo comece a rodar */
...
void jogo(int **matriz, int nl, int nc, int iter)
{
    ...
    /* TODO: comente adequadamente explicando porque eh preciso invocar copia_matriz aqui()
        para que a matriz original não seja alterada antes do resultado do jogo */
    ...
    for(k=0; k<iter; k++)
    {
        ...
        /* TODO: comente adequadamente explicando porque eh preciso invocar copia_matriz aqui()
            para que as duas matrizes tenham as mesmas informações para a próxima iteração*/
    ...
    destroiMatriz(copia, nl);
    destroiMatriz(matriz, nl);
